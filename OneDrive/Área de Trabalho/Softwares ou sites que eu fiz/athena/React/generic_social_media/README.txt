...
* npx expo install react-native-gesture-handler
  O aplicativo faz uso da navegação em pilha, então tive que instalar estes pacotes.
  Segui as instruções no site oficial do React Navigation para instalação

* npm i yup
  Yup foi utilizado para a tela de login. Ele foi feito seguindo um video da biblioteca Athena, a qual explicava seu funcionamento.

Feito por Estevão Augusto da Fonseca Santos
